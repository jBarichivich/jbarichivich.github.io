...
New approaches are required to advance current mechanistic understanding and projection of decadal and century-scale responses of mature forests to global change factors (e.g., climate, CO2, nitrogen, pollutants). Such advances are crucial to constrain and improve plant growth representations in current process-based models and thereby reduce uncertainties in future projections of the state of terrestrial ecosystems and feedbacks with global climate.
