...
Global change experiments under controlled conditions are the backbone of the development, parameterization and benchmarking of current process-based models from plant organs to the global land surface. These manipulative experimental approaches can not provide robust insights on the temporal evolution of plant responses to global change factors at decadal and century time scales. New approaches are required to advance current mechanistic understanding of long-term and whole-tree growth responses of mature trees to global change factors. Such advances are crucial to constrain and improve plant growth representations in current process-based models and thereby reduce uncertainties in future projections of the state of terrestrial ecosystems and feedbacks with global climate.
