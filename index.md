...
I am a senior scientist (Directeur de Recherche) in the CNRS and ERC-stg grantee at the Laboratoire des Sciences du Climat et de l’Environnement (LSCE) in Paris, France. In my near-term research program I seek to improve the ecology of the [terrestrial component](https://bg.copernicus.org/preprints/bg-2020-446/) of an Earth System model using tree rings. 
...
- Feature in [ScienceInsider: Plants & Animals](https://www.science.org/content/article/world-s-oldest-tree-growing-ravine-chile) about the ancient Alerce Milenario monumental tree growing in the Chilean rainforest, May 2022.
